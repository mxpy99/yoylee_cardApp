...
<body>
	...
	<%
		...
		System.out.println("recycle :card = "+cards);
	%>
	<div class="div_body">
		<span>回收站</span>
			<%
				...
				if(cards!=null){
					for(int i = 0;i<cards.size();i++){
						...
						out.print("<td>"+"<a class='a_1' href='huanyuanCardController"+"?name="+cards.get(i).getName()+"'>还原</a>");
						out.print("<td>"+"<a class='a_1' href='shanchuCardController"+"?name="+cards.get(i).getName()+"'>删除</a>");
					}
				}
				out.print("</table>");
			%>
