...
<body>
	<%
		String yuanname =(String) request.getAttribute("yuanname");  
	%>>
	<!-- title部分 -->
	<div class="div_title">
	...
	<div class="div_body">
		<div>
			<h3>修改名片</h3>
			<form action="updateCardController1">
				正在修改的名片:<%= yuanname %><br>
				...
				<input type="text" name="yuanname" value = <%=yuanname %> style="display: none;">
				<input type="submit" value="修改名片">
