...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="loginForm.jsp"
				style="font-size: 22px; color: #FFF;"> 名片管理<font color="#FFCC00">CardManage</font><span
		...
		<form action="loginController" method="post" id="loginForm">
			<div class="page-body">
				...
				<div class="relogin">
						...
						<a class="btn green" href="registerForm"
							style="margin-left: 20px" >注册<span class="m-icon-swapright m-icon-white"> </a> 
				</div>
			</div>
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2017 
			</div>
		</form>
	</div>
	<script
