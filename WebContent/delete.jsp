...
<body>
	...
	<%
		...
		System.out.println("select :card = "+cards);
	%>
			...
			<%
				...
				if(cards!=null){
					for(int i = 0;i<cards.size();i++){
						...
						out.print("<td>"+"<a class='a_1' href='deleteCardController"+"?name="+cards.get(i).getName()+"'>删除</a>");
						out.print("<td>"+"<a class='a_1' href='recycleCardController"+"?name="+cards.get(i).getName()+"'>放入回收站</a>");
					}
				}
				out.print("</table>");
			%>
